				...
				command_tests => [
						  {
						   ...
						   read => [ `cat $::config->{core_directory}/tests/library/strings/pool1.txt`, ],
						   timeout => 8,
						   write => undef,
						  },
						 ],
				...
				command_tests => [
						  {
						   ...
						   read => [ `cat $::config->{core_directory}/tests/library/strings/pool2.txt`, ],
						   timeout => 8,
						   write => undef,
						  },
						 ],
				...
				command_tests => [
						  {
						   ...
						   read => [ `cat $::config->{core_directory}/tests/library/strings/pool1-feedback1.txt`, ],
						   timeout => 8,
						   write => undef,
						  },
						 ],
				...
				command_tests => [
						  {
						   ...
						   read => [ `cat $::config->{core_directory}/tests/library/strings/pool1-feedback2.txt`, ],
						   timeout => 8,
						   write => undef,
						  },
						 ],
